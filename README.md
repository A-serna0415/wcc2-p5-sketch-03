...
*https://github.com/A-serna0415/wcc2-p5-sketch-03.git*

**Instructions:**
1. Hover the cursor over the creature to increase its fitness value, which means, its chances to survive the next generation.
2. Press *Evolve Next Generation* button to evolve the creatures.
3. Refresh the sketch to go back to the generation 0.
